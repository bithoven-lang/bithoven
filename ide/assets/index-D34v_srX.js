...
(async () => {
  ...
  function TA() {
    ...
    function R(M, H, W, $, dt) {
      ...
      Et = 0;
      var ze = $ === "" ? "." : $ + ":";
      if (N(M)) for (var ne = 0; ne < M.length; ne++) $ = M[ne], bt = ze + ht($, ne), Et += R($, H, W, bt, dt);
      else if (ne = S(M), typeof ne == "function") for (M = ne.call(M), ne = 0; !($ = M.next()).done; ) $ = $.value, bt = ze + ht($, ne++), Et += R($, H, W, bt, dt);
      else if (bt === "object") {
    ...
    return gt.Activity = y, gt.Children = mt, gt.Component = T, gt.Fragment = e, gt.Profiler = r, gt.PureComponent = L, gt.StrictMode = n, gt.Suspense = h, gt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = V, gt.__COMPILER_RUNTIME = {
      ...
      if (Et === 1) dt.children = W;
        ...
        for (var ze = Array(Et), ne = 0; ne < Et; ne++) ze[ne] = arguments[ne + 2];
        dt.children = ze;
      }
...
` + u.stack;
    ...
    function Ln(i) {
      var s = i.alternate;
      W(le, le.current & 1), W(ii, i), yi === null && (s === null || hs.current !== null || s.memoizedState !== null) && (yi = i);
    }
    function Mf(i) {
      W(le, le.current), W(ii, i), yi === null && (yi = i);
    }
    function xp(i) {
      i.tag === 22 ? (W(le, le.current), W(ii, i), yi === null && (yi = i)) : Hn();
    }
    function Hn() {
      W(le, le.current), W(ii, ii.current);
    }
    function ni(i) {
      H(ii), yi === i && (yi = null), H(le);
    }
    var le = M(0);
    function go(i) {
      for (var s = i; s !== null; ) {
    ...
    var l0 = {
      ...
      useTransition: function() {
        var i = So(cn)[0], s = se().memoizedState;
        return [
    ...
    var s0 = {
      ...
      useTransition: function() {
        var i = Rf(cn)[0], s = se().memoizedState;
        return [
          typeof i == "boolean" ? i : Mr(i),
          s
        ];
    ...
    function Aw(i, s, o, u, d) {
      if (o.flags |= 32768, u !== null && typeof u == "object" && typeof u.then == "function") {
        if (s = o.alternate, s !== null && as(s, o, d, true), o = ii.current, o !== null) {
          switch (o.tag) {
            case 31:
            case 13:
              return yi === null ? Lo() : o.alternate === null && ee === 0 && (ee = 3), o.flags &= -257, o.flags |= 65536, o.lanes = d, u === uo ? o.flags |= 16384 : (s = o.updateQueue, s === null ? o.updateQueue = /* @__PURE__ */ new Set([
                u
      ...
      if (kt) return s = ii.current, s !== null ? ((s.flags & 65536) === 0 && (s.flags |= 256), s.flags |= 65536, s.lanes = d, u !== uf && (i = Error(n(422), {
        ...
        cause: u
      }), pr(di(s, o))), i = i.current.alternate, i.flags |= 65536, d &= -d, i.lanes |= d, u = di(u, o), d = Kf(i.stateNode, u, d), xf(i, d), ee !== 4 && (ee = 2)), false;
      var m = Error(n(520), {
        cause: u
      });
      if (m = di(m, o), Nr === null ? Nr = [
        m
      ] : Nr.push(m), ee !== 4 && (ee = 2), s === null) return true;
      u = di(u, o), o = s;
      do {
        switch (o.tag) {
          case 3:
    ...
    function A0(i, s, o) {
      ...
      if ((b = m) || (b = i !== null && i.memoizedState === null ? false : (le.current & 2) !== 0), b && (d = true, s.flags &= -129), b = (s.flags & 32) !== 0, s.flags &= -33, i === null) {
        if (kt) {
    ...
    function M0(i, s, o) {
      ...
      u = u.children;
      var b = le.current, x = (b & 2) !== 0;
      if (x ? (b = b & 1 | 2, s.flags |= 128) : b &= 1, W(le, b), xe(i, s, u, o), u = kt ? gr : 0, !x && i !== null && (i.flags & 128) !== 0) t: for (i = s.child; i !== null; ) {
    ...
    function Mw(i, s, o) {
      switch (s.tag) {
        ...
        case 19:
          ...
          if (d = s.memoizedState, d !== null && (d.rendering = null, d.tail = null, d.lastEffect = null), W(le, le.current), u) break;
          return null;
        case 22:
    ...
    function _w(i, s, o) {
      ...
      switch (cf(s), s.tag) {
        ...
        case 1:
          return Zt(s), null;
        case 3:
          return o = s.stateNode, u = null, i !== null && (u = i.memoizedState.cache), s.memoizedState.cache !== u && (s.flags |= 2048), an(ae), ne(), o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), (i === null || i.child === null) && (rs(s) ? fn(s) : i === null || i.memoizedState.isDehydrated && (s.flags & 256) === 0 || (s.flags |= 1024, ff())), Zt(s), null;
        case 26:
        ...
        case 4:
          return ne(), i === null && Ah(s.stateNode.containerInfo), Zt(s), null;
        case 10:
          return an(s.type), Zt(s), null;
        case 19:
          if (H(le), u = s.memoizedState, u === null) return Zt(s), null;
          if (d = (s.flags & 128) !== 0, m = u.rendering, m === null) if (d) Or(u, false);
          else {
            if (ee !== 0 || i !== null && (i.flags & 128) !== 0) for (i = s.child; i !== null; ) {
              if (m = go(i), m !== null) {
                ...
                return W(le, le.current & 1 | 2), kt && sn(s, u.treeForkCount), s.child;
              }
              i = i.sibling;
            }
          ...
          return u.tail !== null ? (i = u.tail, u.rendering = i, u.tail = i.sibling, u.renderingStartTime = Pe(), i.sibling = null, o = le.current, W(le, d ? o & 1 | 2 : o & 1), kt && sn(s, u.treeForkCount), i) : (Zt(s), null);
        case 22:
        case 23:
    ...
    function kw(i, s) {
      switch (cf(s), s.tag) {
        ...
        case 3:
          return an(ae), ne(), i = s.flags, (i & 65536) !== 0 && (i & 128) === 0 ? (s.flags = i & -65537 | 128, s) : null;
        case 26:
        case 27:
        case 5:
          return Ua(s), null;
    ...
    }, Ew = typeof WeakMap == "function" ? WeakMap : Map, Lt = 0, Gt = null, At = null, Mt = 0, Ht = 0, li = null, Vn = false, bs = false, oh = false, pn = 0, ee = 0, qn = 0, Ol = 0, ch = 0, si = 0, vs = 0, Nr = null, Ke = null, uh = false, Bo = 0, Z0 = 0, Ro = 1 / 0, zo = null, jn = null, he = 0, Yn = null, Ss = null, yn = 0, fh = 0, hh = null, W0 = null, Lr = 0, dh = null;
    function ri() {
    ...
    function Qe(i, s, o) {
      (i === Gt && (Ht === 2 || Ht === 9) || i.cancelPendingCommit !== null) && (xs(i, 0), Gn(i, Mt, si, false)), nr(i, o), ((Lt & 2) === 0 || i !== Gt) && (i === Gt && ((Lt & 2) === 0 && (Ol |= o), ee === 4 && Gn(i, Mt, si, false)), Ui(i));
    }
    function F0(i, s, o) {
    ...
    function xs(i, s) {
      ...
      o !== -1 && (i.timeoutHandle = -1, Iw(o)), o = i.cancelPendingCommit, o !== null && (i.cancelPendingCommit = null, o()), yn = 0, mh(), Gt = i, At = o = ln(i.current, null), Mt = s, Ht = 0, li = null, Vn = false, bs = ir(i, s), oh = false, vs = si = ch = Ol = qn = ee = 0, Ke = Nr = null, uh = false, (s & 8) !== 0 && (s |= s & 32);
    ...
    function I0(i, s) {
      vt = null, R.H = kr, s === us || s === co ? (s = mp(), Ht = 3) : s === bf ? (s = mp(), Ht = 4) : Ht = s === Qf ? 8 : s !== null && typeof s == "object" && typeof s.then == "function" ? 6 : 1, li = s, At === null && (ee = 1, Co(i, di(s, i.current)));
    }
    function $0() {
      var i = ii.current;
    ...
    function Lo() {
      ee = 4, Vn || (Mt & 4194048) !== Mt && ii.current !== null || (bs = true), (qn & 134217727) === 0 && (Ol & 134217727) === 0 || Gt === null || Gn(Gt, Mt, si, false);
    }
    function gh(i, s, o) {
      var u = Lt;
      Lt |= 2;
    ...
    function zw(i, s) {
      ...
      while (true);
      return rn = Sl = null, R.H = u, R.A = d, Lt = o, At !== null ? 0 : (Gt = null, Mt = 0, eo(), ee);
    }
    function Nw() {
    ...
    function ws(i, s, o, u) {
      ...
      try {
        if (Aw(i, d, s, o, Mt)) {
          ee = 1, Co(i, di(o, i.current)), At = null;
          return;
        }
      } catch (m) {
    ...
    function Lw(i, s, o) {
      var u = i.pingCache;
      u !== null && u.delete(s), i.pingedLanes |= i.suspendedLanes & o, i.warmLanes &= ~o, Gt === i && (Mt & o) === o && (ee === 4 || ee === 3 && (Mt & 62914560) === Mt && 300 > Pe() - Bo ? (Lt & 2) === 0 && xs(i, 0) : ch |= o, vs === Mt && (vs = 0)), Ui(i);
    }
    function hy(i, s) {
...
`).replace(Ww, "");
  ...
  var NA = zA();
  const LA = "/bithoven/ide/assets/bithoven_bg-BM2Ia1tD.wasm", HA = async (l = {}, t) => {
    let e;
  ...
  class qs {
    ...
    constructor(t, e, n) {
      const r = Ys(t, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), a = Ji, c = Ys(e, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), f = Ji, h = _C(n, Tt.__wbindgen_malloc), g = Ji, p = Tt.bithovenoutput_new(r, a, c, f, h, g);
      return this.__wbg_ptr = p, Jh.register(this, this.__wbg_ptr, this), this;
    }
    to_object() {
  ...
  function UA(l) {
    const t = Ys(l, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), e = Ji, n = Tt.compile_program(t, e);
    if (n[2]) throw kC(n[1]);
    return qs.__wrap(n[0]);
  }
  function VA(l, t) {
    return Error(js(l, t));
  }
  ...
  function jA(l, t) {
    const e = String(t), n = Ys(e, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), r = Ji;
  ...
  function GA(l, t) {
    const e = Md(t), n = Ys(e, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), r = Ji;
    ll().setInt32(l + 4, r, true), ll().setInt32(l + 0, n, true);
  }
  function XA(l, t) {
    return l in t;
  ...
  function FA(l, t) {
    ...
    var r = jc(n) ? 0 : Ys(n, Tt.__wbindgen_malloc, Tt.__wbindgen_realloc), a = Ji;
    ll().setInt32(l + 4, a, true), ll().setInt32(l + 0, r, true);
  }
  function PA(l, t) {
    throw new Error(js(l, t));
  }
  function IA() {
  ...
  } : new FinalizationRegistry((l) => Tt.__wbg_bithovenoutput_free(l, 1));
  function MC(l) {
...
${l.stack}` : n;
  ...
  let Fh = 0;
  function OC(l, t) {
    return Fh += t, Fh >= TC && (Oc = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
    }), Oc.decode(), Fh = t), Oc.decode(zs().subarray(l, l + t));
  }
  ...
  const $t = await HA({
    "./bithoven_bg.js": {
      __wbg_length_4e1adc0d42e23620: cC,
      __wbg_get_unchecked_363572bdd397d473: eC,
      __wbg_next_f31ecb8646d2c605: gC,
      __wbg_done_cffed884d87aa22e: $A,
      __wbg_value_c227f843d21da141: SC,
      __wbg_set_13d25b81ab403f5e: yC,
      __wbg_get_with_ref_key_6412cf3094599694: iC,
      __wbg_set_6be42768c690e380: bC,
      __wbg_String_8564e559799eccda: jA,
      __wbg_iterator_22ddeb808cf55a6f: aC,
      __wbg_get_6cf5a4d4d8ad3c5a: tC,
      __wbg_call_269c5566fbede3eb: IA,
      __wbg_next_95053e306b1c3aed: mC,
      __wbg_new_bebc3f4757acf305: hC,
      __wbg_new_ffa92086ea89f79c: dC,
      __wbg_isArray_5674713bb7b79043: sC,
      __wbg_new_a32a1ab6c6655abe: fC,
      __wbg_isSafeInteger_8f51c743827d1ec5: rC,
      __wbg_length_31bdaf014f5fbde2: oC,
      __wbg_prototypesetcall_ae9f5e7459250748: pC,
      __wbg_new_1da3429bc3c4541c: uC,
      __wbg_instanceof_ArrayBuffer_d4ff01f8247925ae: nC,
      __wbg_instanceof_Uint8Array_598adc0fef426aa8: lC,
      __wbg_set_a377297433dfea63: vC,
      __wbg___wbindgen_number_get_1dc732b810cb937c: JA,
      __wbg___wbindgen_in_50072d4d6e45c193: XA,
      __wbg___wbindgen_throw_5d9e815e6fdf150f: PA,
      __wbg_Number_c54e7112a3fa7e3e: qA,
      __wbg_Error_67e7344beaa85059: VA,
      __wbg___wbindgen_is_object_edb6b15aa3afe12e: QA,
      __wbg___wbindgen_string_get_92ab86bb19cbc12f: FA,
      __wbg___wbindgen_boolean_get_7a12af2b3f899c5a: YA,
      __wbg___wbindgen_is_function_fcda5e3902d732fe: KA,
      __wbg___wbindgen_is_undefined_8c687d0b90d5b524: ZA,
      __wbg___wbindgen_jsval_loose_eq_3c30021c243b64cd: WA,
      __wbg___wbindgen_debug_string_0e68cf47c9cbd9b0: GA,
      __wbindgen_init_externref_table: CC,
      __wbindgen_generic_0000000000000001: xC,
      __wbindgen_generic_0000000000000002: wC,
      __wbindgen_generic_0000000000000003: AC
    }
  }, LA), EC = $t.memory, BC = $t.__wbg_bithovenoutput_free, RC = $t.bithovenoutput_asm, zC = $t.bithovenoutput_bytes, NC = $t.bithovenoutput_from_object, LC = $t.bithovenoutput_hex, HC = $t.bithovenoutput_new, UC = $t.bithovenoutput_to_object, VC = $t.compile_program, qC = $t.rustsecp256k1_v0_10_0_default_error_callback_fn, jC = $t.rustsecp256k1_v0_10_0_default_illegal_callback_fn, YC = $t.rustsecp256k1_v0_10_0_context_destroy, GC = $t.rustsecp256k1_v0_10_0_context_create, XC = $t.__abort_handler, KC = $t.__instance_terminated, QC = $t.__wbindgen_malloc, ZC = $t.__wbindgen_realloc, WC = $t.__wbindgen_exn_store, JC = $t.__externref_table_alloc, FC = $t.__wbindgen_externrefs, PC = $t.__wbindgen_free, IC = $t.__externref_table_dealloc, rv = $t.__wbindgen_start, $C = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: XC,
    __externref_table_alloc: JC,
    __externref_table_dealloc: IC,
    __instance_terminated: KC,
    __wbg_bithovenoutput_free: BC,
    __wbindgen_exn_store: WC,
    __wbindgen_externrefs: FC,
    __wbindgen_free: PC,
    __wbindgen_malloc: QC,
    __wbindgen_realloc: ZC,
    __wbindgen_start: rv,
    ...
    compile_program: VC,
    memory: EC,
    rustsecp256k1_v0_10_0_context_create: GC,
    rustsecp256k1_v0_10_0_context_destroy: YC,
  ...
  const db = 8205;
  function iM(l, t, e = true, n = true) {
    return (e ? ov : nM)(l, t, n);
  }
  function ov(l, t, e) {
    ...
    for (t += mb(n); t < l.length; ) {
      let r = Ph(l, t);
      if (n == db || r == db || e && eM(r)) t += mb(r), n = r;
      else if (hb(r)) {
        let a = 0, c = t - 2;
  ...
  class Rt {
    ...
    static of(t) {
      ...
      return t.length == 1 && !t[0] ? Rt.empty : t.length <= 32 ? new re(t) : Gi.from(re.split(t, []));
    }
  }
  class re extends Rt {
    constructor(t, e = lM(t)) {
    ...
    lineInner(t, e, n, r) {
      for (let a = 0; ; a++) {
        ...
        if ((e ? n : f) >= t) return new sM(r, f, n, c);
        r = f + 1, n++;
      }
    }
    decompose(t, e, n, r) {
      let a = t <= 0 && e >= this.length ? this : new re(gb(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
      if (r & 1) {
        let c = n.pop(), f = Dc(a.text, c.text.slice(), 0, a.length);
        if (f.length <= 32) n.push(new re(f, c.length + a.length));
        else {
          let h = f.length >> 1;
          n.push(new re(f.slice(0, h)), new re(f.slice(h)));
        }
      } else n.push(a);
    }
    replace(t, e, n) {
      if (!(n instanceof re)) return super.replace(t, e, n);
      [t, e] = Gs(this, t, e);
      let r = Dc(this.text, Dc(n.text, gb(this.text, 0, t)), e), a = this.length + n.length - (e - t);
      return r.length <= 32 ? new re(r, a) : Gi.from(re.split(r, []), a);
    }
...
`) {
    ...
    static split(t, e) {
      let n = [], r = -1;
      for (let a of t) n.push(a), r += a.length + 1, n.length == 32 && (e.push(new re(n, r)), n = [], r = -1);
      return r > -1 && e.push(new re(n, r)), e;
    }
  }
  class Gi extends Rt {
    constructor(t, e) {
...
`) {
    ...
    static from(t, e = t.reduce((n, r) => n + r.length + 1, -1)) {
      ...
      function y(S) {
        ...
        else S.lines > c && (h > c || !h) ? (v(), f.push(S)) : S instanceof re && h && (w = p[p.length - 1]) instanceof re && S.lines + w.lines <= 32 ? (h += S.lines, g += S.length + 1, p[p.length - 1] = new re(w.text.concat(S.text), w.length + 1 + S.length)) : (h + S.lines > r && v(), h += S.lines, g += S.length + 1, p.push(S));
      }
      function v() {
  ...
  class ra {
    constructor(t, e = 1) {
      this.dir = e, this.done = false, this.lineBreak = false, this.value = "", this.nodes = [
        ...
        e > 0 ? 1 : (t instanceof re ? t.text.length : t.children.length) << 1
      ];
    }
    nextInner(t, e) {
      for (this.done = this.lineBreak = false; ; ) {
        let n = this.nodes.length - 1, r = this.nodes[n], a = this.offsets[n], c = a >> 1, f = r instanceof re ? r.text.length : r.children.length;
        if (c == (e > 0 ? f : 0)) {
...
`, this;
          ...
          t > h.length ? (t -= h.length, this.offsets[n] += e) : (e < 0 && this.offsets[n]--, this.nodes.push(h), this.offsets.push(e > 0 ? 1 : (h instanceof re ? h.text.length : h.children.length) << 1));
        }
      }
    }
    next(t = 0) {
  ...
  function Ze(l, t) {
    let e = l.charCodeAt(t);
    if (!aM(e) || t + 1 == l.length) return e;
    let n = l.charCodeAt(t + 1);
    return rM(n) ? (e - 55296 << 10) + (n - 56320) + 65536 : e;
  }
  function Cm(l) {
  ...
  class Yc {
    ...
    static resolve(t, e, n) {
      ...
      for (let v of cM(t, e, c)) v instanceof ke ? r.push(v) : (a[v.facet.id] || (a[v.facet.id] = [])).push(v);
      ...
      for (let v in a) {
        ...
        if (S.every((_) => _.type == 0)) if (f[w.id] = h.length << 1 | 1, _m(A, S)) h.push(n.facet(w));
          ...
          f[w.id] = g.length << 1, g.push((_) => oM(_, w, S));
        }
      }
      let y = g.map((v) => v(f));
  ...
  function dM(l) {
    ...
    for (let r of t.facet(bv)) {
      ...
      Array.isArray(a) && (e = e === true ? a : hM(e, a));
    }
    if (e !== true) {
      let r, a;
  ...
  const gM = [];
  function Ns(l) {
    return l == null ? gM : Array.isArray(l) ? l : [
      l
    ];
  }
  var It = (function(l) {
  ...
  function yM(l) {
    ...
    for (let t = 0; t < l.length; t++) {
      let e = l[t];
      if (/\w/.test(e) || e > "\x80" && (e.toUpperCase() != e.toLowerCase() || pM.test(e))) return true;
    }
    return false;
  }
  function bM(l) {
...
`;
    ...
    charCategorizer(t) {
      return bM(this.languageDataAt("wordChars", t).join(""));
    }
    wordAt(t) {
  ...
  class Bt {
    ...
    static of(t, e = false) {
      ...
      for (let r of t instanceof Ld ? [
        t
      ] : e ? vM(t) : t) n.add(r.from, r.to, r.value);
      return n.finish();
    }
    static join(t) {
...
`);
    ...
    static mount(t, e, n) {
      ...
      r ? a && r.setNonce(a) : r = new SM(t, a), r.mount(Array.isArray(e) ? e : [
        e
      ], t);
    }
  }
...
`;
  ...
  var rl = {
    ...
    221: "}",
    222: '"'
  }, xM = typeof navigator < "u" && /Mac/.test(navigator.platform), wM = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
  ...
  function AM(l) {
    var t = xM && l.metaKey && l.shiftKey && !l.ctrlKey && !l.altKey || wM && l.shiftKey && l.key && l.key.length == 1 || l.key == "Unidentified", e = !t && l.key || (l.shiftKey ? ga : rl)[l.keyCode] || l.key || "Unidentified";
  ...
  var F = {
    ...
    webkit_version: CM ? +(/\bAppleWebKit\/(\d+)/.exec(Le.userAgent) || [
      0,
      0
    ])[1] : 0,
    safari: Kd,
  ...
  class Ei extends Yt {
    ...
    merge(t, e, n) {
      return this.flags & 8 || n && (!(n instanceof Ei) || this.length - (e - t) + n.length > EM || n.flags & 8) ? false : (this.text = this.text.slice(0, t) + (n ? n.text : "") + this.text.slice(e), this.markDirty(), true);
    }
    split(t) {
  ...
  function Vv(l, t, e) {
    ...
    function f(g, p) {
      for (let y = 0, v = 0; y < g.children.length && v <= p; y++) {
        ...
        w >= p && (S.children.length ? f(S, p - v) : (!a || a.isHidden && (e > 0 || zM(a, S))) && (w > p || v == w && S.getSide() > 0) ? (a = S, c = p - v) : (v < p || v == w && S.getSide() < 0 && !S.isHidden) && (n = S, r = p - v)), v = w;
      }
    }
    f(l, t);
    let h = (e < 0 ? n : a) || n || a;
    return h ? h.coordsAt(Math.max(0, h == n ? r : c), e) : RM(l);
  }
  function RM(l) {
  ...
  class al extends ct {
    ...
    eq(t) {
      return t instanceof al && LM(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
    }
    range(t, e = t) {
  ...
  const HM = jv("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), UM = jv("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Fd = /* @__PURE__ */ Object.create(null), Vi = [];
  for (let l of [
    "()",
    "[]",
    "{}"
  ...
  function Yv(l) {
    return l <= 247 ? HM[l] : 1424 <= l && l <= 1524 ? 2 : 1536 <= l && l <= 1785 ? UM[l - 1536] : 1774 <= l && l <= 2220 ? 4 : 8192 <= l && l <= 8204 ? 256 : 64336 <= l && l <= 65023 ? 4 : 1;
  }
  const VM = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
  class el {
    get dir() {
  ...
  function Id(l, t, e, n, r, a, c) {
    let f = t % 2 ? 2 : 1;
    qM(l, r, a, n, f), jM(l, r, a, n, f), YM(r, a, n, f), Pd(l, r, a, t, e, n, c);
  }
  function GM(l, t, e) {
    if (!l) return [
      new el(0, 0, t == Om ? 1 : 0)
    ];
    if (t == jl && !e.length && !VM.test(l)) return Xv(l.length);
  ...
  class ie {
    ...
    static fromClass(t, e) {
      return ie.define((n, r) => new t(n, r), e);
    }
  }
  class ed {
    constructor(t) {
    ...
    return Bt.spans(n, t.from, t.to, {
      ...
      span(a, c, f, h) {
        ...
        for (let v = f.length - 1; v >= 0; v--, h--) {
          ...
          if (S == null && (S = KM(t.text, g, p)), h > 0 && y.length && (w = y[y.length - 1]).to == g && w.direction == S) w.to = p, y = w.inner;
          else {
            let A = {
              from: g,
              to: p,
  ...
  class Db extends Yt {
    ...
    update(t) {
      ...
      let r = -1;
      this.view.inputState.composing >= 0 && !this.view.observer.editContext && (!((e = this.domChanged) === null || e === void 0) && e.newSel ? r = this.domChanged.newSel.head : !$M(t.changes, this.hasComposition) && !t.selectionSet && (r = t.state.selection.main.head));
      let a = r > -1 ? WM(this.view, t.changes, r) : null;
      ...
      let c = this.decorations, f = this.updateDeco(), h = PM(c, f, t.changes);
    ...
    updateSelection(t = false, e = false) {
      ...
      if (F.gecko && f.empty && !this.hasComposition && ZM(h)) {
      ...
      (c || !p.focusNode || (!oa(h.node, h.offset, p.anchorNode, p.anchorOffset) || !oa(g.node, g.offset, p.focusNode, p.focusOffset)) && !this.suppressWidgetCursorChange(p, f)) && (this.view.observer.ignore(() => {
        F.android && F.chrome && this.dom.contains(p.focusNode) && IM(p.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({
          preventScroll: true
        }));
        let y = pa(this.view.root);
        if (y) if (f.empty) {
          if (F.gecko) {
            let v = JM(h.node, h.offset);
            if (v && v != 3) {
    ...
    scrollIntoView(t) {
      ...
      _M(this.view.scrollDOM, c, e.head < e.anchor ? -1 : 1, t.x, t.y, Math.max(Math.min(t.xMargin, f), -f), Math.max(Math.min(t.yMargin, h), -h), this.view.textDirection == Jt.LTR);
    }
    lineHasWidget(t) {
  ...
  function aS(l, t, e, n = -1) {
    ...
    if (_ && ((r = l.docView.nearest(_)) === null || r === void 0 ? void 0 : r.isEditable) != false) {
      ...
      T && (!l.contentDOM.contains(T) || F.safari && n_(T, j, p) || F.chrome && l_(T, j, p)) && (T = void 0), T && (j = Math.min(Pi(T), j));
    }
...
`, r = l.state.doc.line(r.number + (e ? 1 : -1)), a = l.bidiSpans(r), g = l.visualLineSide(r, !e);
  ...
  class o_ {
    ...
    readRange(t, e) {
      ...
      for (let r = t; ; ) {
        ...
        (f && h ? f.breakAfter : (f ? f.breakAfter : Xc(r)) || Xc(c) && (r.nodeName != "BR" || r.cmIgnore) && this.text.length > a) && !u_(c, e) && this.lineBreak(), r = c;
      }
    ...
    findPointInside(t, e) {
      for (let n of this.points) (t.nodeType == 3 ? n.node == t : t.contains(n.node)) && (n.pos = this.text.length + (c_(t, n.node, n.offset) ? e : 0));
    }
  }
  function c_(l, t, e) {
    for (; ; ) {
  ...
  class f_ {
    constructor(t, e, n, r) {
      ...
      if (t.state.readOnly && e > -1) this.newSel = null;
        ...
        let f = a || c ? [] : d_(t), h = new o_(f, t.state);
        h.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = h.text, this.newSel = m_(f, this.bounds.from);
      } else {
 ...
 ` && l.lineWrapping && (n && (n = K.single(n.main.anchor - 1, n.main.head - 1)), e = {
  ...
  class g_ {
    ...
    ensureHandlers(t) {
      let e = p_(t), n = this.handlers, r = this.view.contentDOM;
    ...
    keydown(t) {
      ...
      let e;
      return F.ios && !t.synthetic && !t.altKey && !t.metaKey && ((e = hS.find((n) => n.keyCode == t.keyCode)) && !t.ctrlKey || y_.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey) ? (this.pendingIOSKey = e || t, setTimeout(() => this.flushIOSKey(), 250), true) : (t.keyCode != 229 && this.view.observer.forceFlush(), false);
    }
    flushIOSKey(t) {
  ...
  class v_ {
    constructor(t, e, n, r) {
      this.view = t, this.startEvent = e, this.style = n, this.mustSelect = r, this.scrollSpeed = {
        x: 0,
        y: 0
      }, this.scrolling = -1, this.lastEvent = e, this.scrollParents = kM(t.contentDOM), this.atoms = t.state.facet(Ba).map((c) => c(t));
      let a = t.contentDOM.ownerDocument;
      a.addEventListener("mousemove", this.move = this.move.bind(this)), a.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = e.shiftKey, this.multiple = t.state.facet(Ot.allowMultipleSelections) && S_(t, e), this.dragging = w_(t, e) && pS(e) == 1 ? null : false;
    }
    start(t) {
    ...
    move(t) {
      ...
      if (this.dragging || this.dragging == null && b_(this.startEvent, t) < 10) return;
  ...
  Bi.mousedown = (l, t) => {
    ...
    if (!e && t.button == 0 && (e = k_(l, t)), e) {
      let n = !l.hasFocus;
      l.inputState.startMouseSelection(new v_(l, t, e, n)), n && l.observer.ignore(() => {
        Ov(l.contentDOM);
  ...
  function qb(l, t) {
    ...
    return {
      pos: e,
      bias: M_(l, e, t.clientX, t.clientY)
    };
  }
  const __ = F.ie && F.ie_version <= 11;
  let jb = null, Yb = 0, Gb = 0;
  function pS(l) {
    if (!__) return l.detail;
    let t = jb, e = Gb;
  ...
  function k_(l, t) {
    ...
    return {
      ...
      get(a, c, f) {
        ...
        return c ? r.replaceRange(r.main.extend(p.from, p.to)) : f && n == 1 && r.ranges.length > 1 && (g = T_(r, h.pos)) ? g : f ? r.addRange(p) : K.create([
          p
        ]);
      }
    };
  ...
  function Xb(l, t, e, n) {
    ...
    let r = l.posAtCoords({
      x: t.clientX,
      y: t.clientY
    }, false), { draggedContent: a } = l.inputState, c = n && a && x_(l, t) ? {
      from: a.from,
      to: a.to
    } : null, f = {
      from: r,
  ...
  Bi.paste = (l, t) => {
    ...
    return e ? (gS(l, e.getData("text/plain") || e.getData("text/uri-list")), true) : (C_(l), false);
  };
  function O_(l, t) {
  ...
  let im = null;
  Bi.copy = Bi.cut = (l, t) => {
    let { text: e, ranges: n, linewise: r } = D_(l.state);
    if (!e && !r) return false;
    ...
    return a ? (a.clearData(), a.setData("text/plain", e), true) : (O_(l, e), false);
  };
  const yS = Ii.define();
  function bS(l, t) {
    let e = [];
  ...
  class Ve {
    ...
    static of(t) {
      ...
      let c = 0;
      return t[e - 1] == null ? (c = 1, e--) : t[e] == null && (c = 1, n++), new z_(Ve.of(t.slice(0, e)), c, Ve.of(t.slice(n)));
    }
  }
  function Zc(l, t) {
  ...
  class Nm {
    ...
    point(t, e, n) {
      if (t < e || n.heightRelevant) {
        ...
        let c = e - t;
        n.block ? this.addBlock(new SS(c, r, n)) : (c || a || r >= N_) && this.addLineDeco(r, a, c);
  ...
  class ld {
    ...
    draw(t, e) {
      return ct.replace({
        widget: new j_(this.displaySize * (e ? t.scaleY : t.scaleX), e)
  ...
  class Jb {
    constructor(t) {
      ...
      this.heightOracle = new B_(e), this.stateDeco = t.facet(ya).filter((n) => typeof n != "function"), this.heightMap = Ve.empty().applyChanges(this.stateDeco, Rt.empty, this.heightOracle.setDoc(t.doc), [
    ...
    update(t, e = null) {
      ...
      let r = t.changedRanges, a = Ai.extendWithRanges(r, L_(n, this.stateDeco, t ? t.changes : de.empty(this.state.doc.length))), c = this.heightMap.height, f = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
    ...
    measure(t) {
      ...
      let w = (this.printing ? q_ : U_)(e, this.paddingTop), A = w.top - this.pixelViewport.top, _ = w.bottom - this.pixelViewport.bottom;
      ...
      if (T != this.inView && (this.inView = T, T && (h = true)), !this.inView && !this.scrollTarget && !V_(t.dom)) return 0;
      let j = f.width;
      if ((this.contentDOMWidth != j || this.editorHeight != t.scrollDOM.clientHeight) && (this.contentDOMWidth = f.width, this.editorHeight = t.scrollDOM.clientHeight, g |= 16), h) {
        ...
        for (let N of this.viewports) {
          ...
          this.heightMap = (c ? Ve.empty().applyChanges(this.stateDeco, Rt.empty, this.heightOracle, [
            new Ai(0, 0, 0, t.state.doc.length)
          ]) : this.heightMap).updateHeight(r, 0, c, new R_(N.from, G));
        }
        Zs && (g |= 2);
      }
    ...
    ensureLineGaps(t, e) {
      ...
      let f = [], h = (p, y, v, S) => {
        ...
        let _ = G_(t, (T) => T.from >= v.from && T.to <= v.to && Math.abs(T.from - p) < a && Math.abs(T.to - y) < a && !A.some((j) => T.from < j && T.to > j));
        if (!_) {
        ...
        let y = Y_(p.from, p.to, this.stateDeco);
        if (y.total < c) return;
  ...
  class Q_ {
    constructor(t) {
      this.view = t, this.active = false, this.editContext = null, this.selectionRange = new TM(), this.selectionChanged = false, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = false, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = t.contentDOM, this.observer = new MutationObserver((e) => {
      ...
      }), window.EditContext && F.android && t.constructor.EDIT_CONTEXT !== false && !(F.chrome && F.chrome_version < 126) && (this.editContext = new W_(t), t.state.facet(vn) && (t.contentDOM.editContext = this.editContext.editContext)), sd && (this.onCharData = (e) => {
        this.queue.push({
          target: e.target,
          type: "characterData",
    ...
    readSelectionRange() {
      ...
      if (!e) return false;
      let n = F.safari && t.root.nodeType == 11 && t.root.activeElement == this.dom && Z_(this.view, e) || e;
      if (!n || this.selectionRange.eq(n)) return false;
      let r = Bc(this.dom, n);
      return r && !this.selectionChanged && t.inputState.lastFocusTime > Date.now() - 200 && t.inputState.lastTouchTime < Date.now() - 300 && DM(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, t.docView.updateSelection(), false) : (this.selectionRange.setRange(n), r && (this.selectionChanged = true), true);
    }
    ...
    start() {
      this.active || (this.observer.observe(this.dom, K_), sd && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = true);
    }
    stop() {
...
`))
  ...
  class P {
    ...
    constructor(t = {}) {
      ...
      let { dispatch: n } = t;
      this.dispatchTransactions = t.dispatchTransactions || n && ((r) => r.forEach((a) => n(a, this))) || ((r) => this.update(r)), this.dispatch = this.dispatch.bind(this), this._root = t.root || OM(t.parent) || document, this.viewState = new Jb(t.state || Ot.create(t)), t.scrollTo && t.scrollTo.is(oc) && (this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(Es).map((r) => new ed(r));
      for (let r of this.plugins) r.update(this);
      this.observer = new Q_(this), this.inputState = new g_(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Db(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), !((e = document.fonts) === null || e === void 0) && e.ready && document.fonts.ready.then(() => this.requestMeasure());
    }
    dispatch(...t) {
    ...
    mountStyles() {
      ...
      sl.mount(this.root, this.styleModules.concat(X_).reverse(), t ? {
        nonce: t
      } : void 0);
    }
    readMeasured() {
    ...
    moveByGroup(t, e) {
      return nd(this, t, Nb(this, t, e, (n) => r_(this, t.head, n)));
    }
    visualLineSide(t, e) {
    ...
    moveToLineBoundary(t, e, n = true) {
      return s_(this, t, e, n);
    }
    moveVertically(t, e, n) {
      return nd(this, t, a_(this, t, e, n));
    }
    domAtPos(t) {
    ...
    bidiSpans(t) {
      if (t.length > J_) return Xv(t.length);
  ...
  const F_ = F.mac ? "mac" : F.windows ? "win" : F.linux ? "linux" : "key";
  function P_(l, t) {
    const e = l.split(/-(?!$)/);
    let n = e[e.length - 1];
    n == "Space" && (n = " ");
  ...
  const I_ = Gl.default(P.domEventHandlers({
    keydown(l, t) {
  ...
  function CS(l) {
    ...
    return e || e1.set(t, e = ek(t.reduce((n, r) => n.concat(r), []))), e;
  }
  function $_(l, t, e) {
  ...
  function ek(l, t = F_) {
    let e = /* @__PURE__ */ Object.create(null), n = /* @__PURE__ */ Object.create(null), r = (c, f) => {
      ...
      var y, v;
      let S = e[c] || (e[c] = /* @__PURE__ */ Object.create(null)), w = f.split(/ (?!$)/).map((T) => P_(T, t));
  ...
  function MS(l, t, e, n) {
    rm = t;
    let r = AM(t), a = Ze(r, 0), c = Xi(a) == r.length && r != " ", f = "", h = false, g = false, p = false;
  ...
  class lk {
    ...
    draw(t) {
      if (t.length != this.drawn.length || t.some((e, n) => !nk(e, this.drawn[n]))) {
  ...
  class hk {
    ...
    createDeco(t) {
      ...
      for (let { from: r, to: a } of fk(t, this.maxLength)) l1(t.state.doc, this.regexp, r, a, (c, f) => this.addMatch(f, t, c, n));
      return e.finish();
    }
    updateDeco(t, e) {
      let n = 1e9, r = -1;
  ...
  const am = /x/.unicode != null ? "gu" : "g", dk = new RegExp(`[\0-\b
-\x7F-\x9F\xAD\u061C\u200B\u200E\u200F\u2028\u2029\u202D\u202E\u2066\u2067\u2069\uFEFF\uFFF9-\uFFFC]`, am), mk = {
    0: "null",
    7: "bell",
    8: "backspace",
  ...
  const Lc = et.define({
    combine(l) {
      ...
      return (t.replaceTabs = !gk()) && (t.specialChars = new RegExp("	|" + t.specialChars.source, am)), t.addSpecialChars && (t.specialChars = new RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, am)), t;
    }
  });
  function pk(l = {}) {
    return [
  ...
  let s1 = null;
  function yk() {
    return s1 || (s1 = ie.fromClass(class {
      constructor(l) {
        ...
        return new hk({
          ...
          decoration: (t, e, n) => {
            ...
            if (a == 9) {
              ...
              return ct.replace({
                widget: new xk((f - h % f) * this.view.defaultCharacterWidth / this.view.scaleX)
              });
            }
  ...
  const bk = "\u2022";
  function vk(l) {
    return l >= 32 ? bk : l == 10 ? "\u2424" : String.fromCharCode(9216 + l);
  }
  class Sk extends Mn {
    constructor(t, e) {
    ...
    toDOM(t) {
      let e = vk(this.code), n = t.state.phrase("Control character") + " " + (mk[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, e);
      if (r) return r;
  ...
  const Ak = ct.line({
    ...
    getDeco(l) {
      ...
      for (let n of l.state.selection.ranges) {
        ...
        r.from > t && (e.push(Ak.range(r.from)), t = r.from);
      }
      return ct.set(e);
    }
  }, {
  ...
  function r1(l, t) {
    let e = l.posAtCoords({
      x: t.clientX,
      y: t.clientY
    }, false), n = l.state.doc.lineAt(e), r = e - n.from, a = r > om ? -1 : r == n.length ? Tk(l, t.clientX) : Ps(n.text, l.state.tabSize, e - n.from);
    return {
      line: n.number,
      col: a,
      off: r
  ...
  function Dk(l) {
    ...
    return P.mouseSelectionStyle.of((e, n) => t(n) ? Ok(e, n) : null);
  }
  const Ek = {
    Alt: [
      18,
  ...
  function Rk(l = {}) {
    let [t, e] = Ek[l.key || "Alt"], n = ie.fromClass(class {
      constructor(r) {
    ...
    return [
      ...
      P.contentAttributes.of((r) => {
        var a;
        return !((a = r.plugin(n)) === null || a === void 0) && a.isDown ? Bk : null;
      })
    ];
  }
  const pc = "-10000px";
  ...
  const ad = et.define({
    combine: (l) => {
      ...
      return {
        ...
        tooltipSpace: ((n = l.find((r) => r.tooltipSpace)) === null || n === void 0 ? void 0 : n.tooltipSpace) || zk
      };
    }
  }), a1 = /* @__PURE__ */ new WeakMap(), Hm = ie.fromClass(class {
    constructor(l) {
    ...
    writeMeasure(l) {
      ...
      for (let f = 0; f < this.manager.tooltips.length; f++) {
        ...
        let S = h.arrow ? g.dom.querySelector(".cm-tooltip-arrow") : null, w = S ? 7 : 0, A = v.right - v.left, _ = (t = a1.get(g)) !== null && t !== void 0 ? t : v.bottom - v.top, T = g.offset || Lk, j = this.view.textDirection == Jt.LTR, L = v.width > n.right - n.left ? j ? n.left : n.right - v.width : j ? Math.max(n.left, Math.min(y.left - (S ? 14 : 0) + T.x, n.right - A)) : Math.min(Math.max(n.left, y.left - A + (S ? 14 : 0) - T.x), n.right - A), Q = this.above[f];
  ...
  class Uk {
    ...
    mousemove(t) {
      ...
      if (r.length && a && !Vk(a.dom, t) || this.pending) {
        let { pos: c } = r[0] || this.pending, f = (n = (e = r[0]) === null || e === void 0 ? void 0 : e.end) !== null && n !== void 0 ? n : c;
        (c == f ? this.view.posAtCoords(this.lastMove) != c : !qk(this.view, c, f, t.clientX, t.clientY)) && (this.view.dispatch({
  ...
  function jk(l, t = {}) {
    let e = St.define(), n = ke.define({
      ...
      update(r, a) {
        ...
        for (let c of a.effects) c.is(e) && (r = c.value), c.is(Yk) && (r = []);
        return r;
      },
      provide: (r) => Jc.from(r)
    });
    return {
      ...
      extension: [
        n,
        ie.define((r) => new Uk(r, l, n, e, t.hoverTime || 300)),
        Hk
      ]
    };
  }
  ...
  const Yk = St.define(), c1 = et.define({
    combine(l) {
      let t, e;
  ...
  const Hc = et.define(), Gk = et.define(), Xk = {
    class: "",
  ...
  const Qk = ie.fromClass(class {
    ...
    syncGutters(l) {
      ...
      let e = Bt.iter(this.view.state.facet(Hc), this.view.viewport.from), n = [], r = this.gutters.map((a) => new Zk(a, this.view.viewport, -this.view.documentPadding.top));
  ...
  class zS {
    ...
    update(t, e, n, r) {
      this.height != e && (this.height = e, this.dom.style.height = e + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Wk(this.markers, r) || this.setMarkers(t, r);
    }
    setMarkers(t, e) {
  ...
  const Jk = et.define(), Fk = et.define(), Bs = et.define({
    combine(l) {
      return $i(l, {
        formatNumber: String,
        domEventHandlers: {}
  ...
  class Dt {
    constructor(t = {}) {
      this.id = nT++, this.perNode = !!t.perNode, this.deserialize = t.deserialize || (() => {
  ...
  class _i {
    ...
    static define(t) {
      let e = t.props && t.props.length ? /* @__PURE__ */ Object.create(null) : lT, n = (t.top ? 1 : 0) | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), r = new _i(t.name || "", e, t.id, n);
      if (t.props) {
        ...
        for (let { children: f, positions: h } = c._tree, g = e > 0 ? f.length : -1; t != g; t += e) {
          ...
          if (NS(r, n, y, y + p.length)) {
            if (p instanceof ol) {
              ...
              if (v > -1) return new il(new sT(c, p, t, y), null, v);
  ...
  function HS(l) {
    ...
    return n ? r[t] = n : r.splice(t, 1), new rT(r, e);
  }
  class rT {
    constructor(t, e) {
  ...
  function oT(l) {
    var t;
    let { buffer: e, nodeSet: n, maxBufferLength: r = iT, reused: a = [], minRepeatType: c = n.types.length } = l, f = Array.isArray(e) ? new Vm(e, e.length) : e, h = n.types, g = 0, p = 0;
  ...
  class cT {
    startParse(t, e, n) {
      return typeof t == "string" && (t = new uT(t)), n = n ? n.length ? n.map((r) => new ud(r.from, r.to)) : [
        new ud(0, 0)
      ] : [
        new ud(0, t.length)
  ...
  class Si {
    constructor(t, e, n, r) {
      this.name = t, this.set = e, this.base = n, this.modified = r, this.id = fT++;
    }
    toString() {
      let { name: t } = this;
  ...
  class Pc {
    constructor(t) {
      this.name = t, this.instances = [], this.id = hT++;
    }
    static get(t, e) {
      if (!e.length) return t;
      let n = e[0].instances.find((f) => f.base == t && dT(e, f.modified));
      if (n) return n;
  ...
  function yT(l, t, e, n = 0, r = l.length) {
    let a = new bT(n, Array.isArray(t) ? t : [
      t
    ], e);
  ...
  class bT {
    ...
    highlightRange(t, e, n, r, a) {
      ...
      let g = r, p = vT(t) || wa.empty, y = pT(a, p.tags);
    ...
    constructor(t, e, n = [], r = "") {
      this.data = t, this.name = r, Ot.prototype.hasOwnProperty("tree") || Object.defineProperty(Ot.prototype, "tree", {
        ...
        Ot.languageData.of((a, c, f) => {
          ...
          if (!g) return [];
          let p = a.facet(g), y = h.type.prop(ST);
          if (y) {
  ...
  const dd = typeof navigator < "u" && (!((hd = navigator.scheduling) === null || hd === void 0) && hd.isInputPending) ? () => navigator.scheduling.isInputPending() : null, wT = ie.fromClass(class {
    constructor(t) {
  ...
  function Ym(l, t) {
    ...
    for (let n of l.state.facet(AT)) {
      let r = n(l, t);
      if (r !== void 0) return r;
    }
    let e = Be(l.state);
    return e.length >= t ? MT(l, e, t) : null;
  }
  class yu {
    constructor(t, e = {}) {
  ...
  function ET(l, t, e, n, r) {
    let a = l.textAfter, c = a.match(/^\s*/)[0].length, f = n && a.slice(c, c + n.length) == n || r == l.pos + c, h = DT(l);
  ...
  function LT(l, t, e) {
    ...
    for (let c = r; c; c = c.next) {
      ...
      if (a && f.from < t) break;
      let h = f.type.prop(NT);
      if (h && (f.to < n.length - 50 || n.length == l.doc.length || !HT(f))) {
        let g = h(f, l);
  ...
  const Yl = ke.define({
    ...
    update(l, t) {
      ...
      for (let e of t.effects) if (e.is(bu) && !UT(l, e.value.from, e.value.to)) {
        let { preparePlaceholder: n } = t.state.facet(QS), r = n ? ct.replace({
          widget: new KT(n(t.state, e.value))
        }) : A1;
        l = l.update({
          add: [
  ...
  function ZT(l = {}) {
    let t = {
      ...QT,
      ...l
    }, e = new md(t, true), n = new md(t, false), r = ie.fromClass(class {
      constructor(c) {
  ...
  class JT {
    ...
    buildDeco(t, e) {
      ...
      let n = new wn();
      for (let { from: r, to: a } of t.visibleRanges) yT(this.tree, e, (c, f, h) => {
  ...
  const FT = Gl.high(ie.fromClass(JT, {
    decorations: (l) => l.decorations
  })), PT = Na.define([
    {
      tag: q.meta,
  ...
  function Zi(l, t, e, n = {}) {
    ...
    for (let h = f; h; h = h.parent) {
      ...
      if (g && h.from < h.to) {
        let p = gm(h);
        if (p && (e > 0 ? t >= p.from && t < p.to : t > p.from && t <= p.to)) return r3(l, t, e, h, p, g, a);
      }
    }
    return a3(l, t, e, c, f.type, r, a);
  }
  function r3(l, t, e, n, r, a, c) {
    let f = n.parent, h = {
      from: r.from,
      to: r.to
  ...
  const o3 = /* @__PURE__ */ Object.create(null), C1 = [
    _i.none
  ], M1 = [], _1 = /* @__PURE__ */ Object.create(null), c3 = /* @__PURE__ */ Object.create(null);
  for (let [l, t] of [
    [
      "variable",
      "variableName"
  ...
  const f3 = (l) => {
    ...
    return n.line ? h3(l) : n.block ? m3(l) : false;
  };
  function Xm(l, t) {
  ...
  const h3 = Xm(y3, 0), d3 = Xm(tx, 0), m3 = Xm((l, t) => tx(l, t, p3(t)), 0);
  function Km(l, t) {
    let e = l.languageDataAt("commentTokens", t, 1);
    return e.length ? e[0] : {};
  }
  const $r = 50;
  function g3(l, { open: t, close: e }, n, r) {
  ...
  function tx(l, t, e = t.selection.ranges) {
    ...
    let r = e.map((a, c) => g3(t, n[c], a.from, a.to));
  ...
  function y3(l, t, e = t.selection.ranges) {
    let n = [], r = -1;
  ...
  const pm = Ii.define(), b3 = Ii.define(), v3 = et.define(), ex = et.define({
    combine(l) {
      return $i(l, {
        minDepth: 100,
        newGroupDelay: 500,
  ...
  const nx = vu(0, false), ym = vu(1, false), x3 = vu(0, true), w3 = vu(1, true);
  class Fe {
    constructor(t, e, n, r, a) {
    ...
    static fromTransaction(t, e) {
      let n = xi;
      for (let r of t.startState.facet(v3)) {
        let a = r(t);
  ...
  function sx(l, t) {
    if (l.length) {
      let e = l[l.length - 1], n = e.selectionsAfter.slice(Math.max(0, e.selectionsAfter.length - M3));
  ...
  class Wi {
    ...
    addChanges(t, e, n, r, a) {
      ...
      return f && f.changes && !f.changes.empty && t.changes && (!n || T3.test(n)) && (!f.selectionsAfter.length && e - this.prevTime < r.newGroupDelay && r.joinToEvent(a, A3(f.changes, t.changes)) || n == "input.type.compose") ? c = iu(c, c.length - 1, r.minDepth, new Fe(t.changes.compose(f.changes), lx(St.mapEffects(t.effects, f.changes), f.effects), f.mapped, f.startSelection, xi)) : c = iu(c, c.length, r.minDepth, t), new Wi(c, xi, e, n);
    }
    addSelection(t, e, n, r) {
      let a = this.done.length ? this.done[this.done.length - 1].selectionsAfter : xi;
      return a.length > 0 && e - this.prevTime < r && n == this.prevUserEvent && n && /^select($|\.)/.test(n) && C3(a[a.length - 1], t) ? this : new Wi(sx(this.done, t), this.undone, e, n);
    }
    addMapping(t) {
  ...
  const D3 = (l) => cx(l, !Re(l)), E3 = (l) => cx(l, Re(l));
  function B3(l, t, e) {
  ...
  const R3 = (l) => zi(l, (t) => xu(l.state, t, !Re(l))), z3 = (l) => zi(l, (t) => xu(l.state, t, Re(l)));
  function ux(l, t) {
    return zi(l, (e) => {
  ...
  const N3 = (l) => zi(l, (t) => ul(l, t, true)), L3 = (l) => zi(l, (t) => ul(l, t, false)), H3 = (l) => zi(l, (t) => ul(l, t, !Re(l))), U3 = (l) => zi(l, (t) => ul(l, t, Re(l))), V3 = (l) => zi(l, (t) => K.cursor(l.lineBlockAt(t.head).from, 1)), q3 = (l) => zi(l, (t) => K.cursor(l.lineBlockAt(t.head).to, -1));
  function j3(l, t, e) {
  ...
  const Y3 = ({ state: l, dispatch: t }) => j3(l, t);
  function ki(l, t) {
  ...
  const G3 = (l) => bx(l, !Re(l)), X3 = (l) => bx(l, Re(l)), K3 = (l) => ki(l, (t) => xu(l.state, t, !Re(l))), Q3 = (l) => ki(l, (t) => xu(l.state, t, Re(l)));
  function vx(l, t) {
  ...
  const T1 = (l) => wx(l, false), O1 = (l) => wx(l, true), Z3 = (l) => ki(l, (t) => ul(l, t, true)), W3 = (l) => ki(l, (t) => ul(l, t, false)), J3 = (l) => ki(l, (t) => ul(l, t, !Re(l))), F3 = (l) => ki(l, (t) => ul(l, t, Re(l))), P3 = (l) => ki(l, (t) => K.cursor(l.lineBlockAt(t.head).from)), I3 = (l) => ki(l, (t) => K.cursor(l.lineBlockAt(t.head).to)), D1 = ({ state: l, dispatch: t }) => (t(Ri(l, {
    anchor: 0
    ...
    anchor: l.selection.main.anchor,
    head: l.doc.length
  })), true), $3 = ({ state: l, dispatch: t }) => (t(l.update({
    selection: {
      anchor: 0,
      head: l.doc.length
    },
    userEvent: "select"
  })), true), tO = ({ state: l, dispatch: t }) => {
    let e = wu(l).map(({ from: n, to: r }) => K.range(n, Math.min(r + 1, l.doc.length)));
    return t(l.update({
      selection: K.create(e),
      userEvent: "select"
    })), true;
  }, eO = ({ state: l, dispatch: t }) => {
  ...
  const iO = (l) => Ax(l, false), nO = (l) => Ax(l, true), lO = ({ state: l, dispatch: t }) => {
  ...
  const Cx = (l, t, e) => La(l, (n) => {
    ...
    return n;
  }), kx = (l) => _x(l, false), sO = (l) => _x(l, true), rO = (l) => La(l, (t) => {
  ...
  const fO = ({ state: l, dispatch: t }) => Tx(l, t, false), hO = ({ state: l, dispatch: t }) => Tx(l, t, true);
  function Ox(l, t, e) {
    if (l.readOnly) return false;
    let n = [];
  ...
  const dO = ({ state: l, dispatch: t }) => Ox(l, t, false), mO = ({ state: l, dispatch: t }) => Ox(l, t, true), gO = (l) => {
    if (l.state.readOnly) return false;
  ...
  const z1 = Dx(false), yO = Dx(true);
  function Dx(l) {
    return ({ state: t, dispatch: e }) => {
      if (t.readOnly) return false;
      let n = t.changeByRange((r) => {
        let { from: a, to: c } = r, f = t.doc.lineAt(a), h = !l && a == c && pO(t, a);
  ...
  })), true), vO = (l) => (l.setTabFocusMode(), true), SO = [
    {
      key: "Ctrl-b",
      run: ax,
      shift: px,
  ...
  const RO = ie.fromClass(class {
    ...
    getDeco(l) {
      let t = l.state.facet(TO), { state: e } = l, n = e.selection;
      ...
      if (r.empty) {
        ...
        if (t.wholeWords) {
          if (a = e.sliceDoc(r.from, r.to), c = e.charCategorizer(r.head), !(H1(c, e, r.from, r.to) && BO(c, e, r.from, r.to))) return ct.none;
      ...
      for (let h of l.visibleRanges) {
        ...
        for (; !g.next().done; ) {
          ...
          if ((!c || H1(c, e, p, y)) && (r.empty && p <= r.from && y >= r.to ? f.push(EO.range(p, y)) : (p >= r.to || y <= r.from) && f.push(DO.range(p, y)), f.length > t.maxMatches)) return ct.none;
        }
      }
      return ct.set(f);
    }
  ...
  const HO = ({ state: l, dispatch: t }) => {
    let { ranges: e } = l.selection;
    if (e.some((a) => a.from === a.to)) return NO({
      state: l,
      dispatch: t
    });
  ...
  class Lx {
    constructor(t) {
      this.search = t.search, this.caseSensitive = !!t.caseSensitive, this.literal = !!t.literal, this.regexp = !!t.regexp, this.replace = t.replace || "", this.valid = !!this.search && (!this.regexp || CO(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!t.wholeWord;
    }
    unquote(t) {
...
` : n == "r" ? "\r" : n == "t" ? "	" : "\\");
    ...
    create() {
      return this.regexp ? new jO(this) : new VO(this);
    }
    getCursor(t, e = 0, n) {
  ...
  function Os(l, t, e, n) {
    return new Js(t.doc, l.unquoted, e, n, l.caseSensitive ? void 0 : (r) => r.toLowerCase(), l.wholeWord ? UO(t.doc, t.charCategorizer(t.selection.main.head)) : void 0);
  }
  function UO(l, t) {
  ...
  function Ds(l, t, e, n) {
    return new zx(t.doc, l.search, {
      ...
      test: l.wholeWord ? qO(t.charCategorizer(t.selection.main.head)) : void 0
    }, e, n);
  }
  function lu(l, t) {
  ...
  const qx = (l) => {
    ...
    if (t && t.panel) {
      ...
      effects: [
        Wm.of(true),
        t ? Ca.of(xm(l.state, t.query.spec)) : St.appendConfig.of(PO)
      ]
    });
    return true;
  }, jx = (l) => {
  ...
  class JO {
    ...
    keydown(t) {
      $_(this.view, t, "search-panel") ? t.preventDefault() : t.keyCode == 13 && t.target == this.searchField ? (t.preventDefault(), (t.shiftKey ? au : ru)(this.view)) : t.keyCode == 13 && t.target == this.replaceField && (t.preventDefault(), U1(this.view));
    }
    update(t) {
  ...
  class rD {
    constructor(t, e, n) {
      ...
      this.optionContent = sD(f), this.optionClass = f.optionClass, this.tooltipClass = f.tooltipClass, this.range = Sd(a.length, c, f.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(t.state), this.dom.addEventListener("mousedown", (h) => {
  ...
  function cD(l, t) {
    ...
    for (let p of l) if (p.hasResult()) {
      ...
      if (p.result.filter === false) for (let v of p.result.options) a(new q1(v, p.source, y ? y(v) : [], 1e9 - e.length));
        ...
        let v = t.sliceDoc(p.from, p.to), S, w = c.filterStrict ? new nD(v) : new iD(v);
  ...
  class cu {
    ...
    static start() {
      return new cu(dD, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
    }
    update(t) {
      let { state: e } = t, n = e.facet(ye), a = (n.override || e.languageDataAt("autocomplete", Hl(e)).map(eD)).map((h) => (this.active.find((p) => p.source == h) || new wi(h, this.active.some((p) => p.state != 0) ? 1 : 0)).update(t, n));
      a.length == this.active.length && a.every((h, g) => h == this.active[g]) && (a = this.active);
      let c = this.open, f = t.effects.some((h) => h.is(Pm));
      c && t.docChanged && (c = c.map(t.changes)), t.selection || a.some((h) => h.hasResult() && t.changes.touchesRange(h.from, h.to)) || !uD(a, this.active) || f ? c = Rs.build(a, e, this.id, c, n, f) : c && c.disabled && !a.some((h) => h.isPending) && (c = null), !c && a.every((h) => !h.isPending) && a.some((h) => h.hasResult()) && (a = a.map((h) => h.hasResult() ? new wi(h.source, 0) : h));
    ...
    get attrs() {
      return this.open ? this.open.attrs : this.active.length ? fD : hD;
    }
  }
  function uD(l, t) {
    if (l == t) return true;
  ...
  class Vs extends wi {
    ...
    updateFor(t, e) {
      ...
      return mD(r.validFor, t.state, a, c) ? new Vs(this.source, this.explicit, h, r, a, c) : r.update && (r = r.update(r, a, c, new Yx(t.state, f, false))) ? new Vs(this.source, this.explicit, h, r, r.from, (n = r.to) !== null && n !== void 0 ? n : Hl(t.state)) : new wi(this.source, 1, this.explicit);
    }
    map(t) {
  ...
  const vD = 50, SD = 1e3, xD = ie.fromClass(class {
    constructor(l) {
    ...
    update(l) {
      ...
      for (let a = 0; a < this.running.length; a++) {
        ...
        if (n || c.context.abortOnDocChange && l.docChanged || c.updates.length + l.transactions.length > vD && Date.now() - c.time > SD) {
    ...
    startQuery(l) {
      let { state: t } = this.view, e = Hl(t), n = new Yx(t, e, l.explicit, this.view), r = new bD(l, n);
  ...
  }), wD = typeof navigator == "object" && /Win/.test(navigator.platform), AD = Gl.highest(P.domEventHandlers({
    keydown(l, t) {
      let e = t.state.field(We, false);
      if (!e || !e.open || e.open.disabled || e.open.selected < 0 || l.key.length > 1 || l.ctrlKey && !(wD && l.altKey) || l.metaKey) return false;
  ...
  const _D = typeof navigator == "object" && /Android\b/.test(navigator.userAgent), kD = P.inputHandler.of((l, t, e, n) => {
    if ((_D ? l.composing : l.compositionStarted) || l.state.readOnly) return false;
    let r = l.state.selection.main;
  ...
  function DD(l, t) {
    ...
    for (let r of n) {
      let a = Wx(Ze(r, 0));
      if (t == r) return a == r ? zD(l, r, n.indexOf(r + r + r) > -1, e) : BD(l, r, a, e.before || _a.before);
      if (t == a && Fx(l, l.selection.main.from)) return RD(l, r, a);
    }
    return null;
  }
  function Fx(l, t) {
  ...
  function zD(l, t, e, n) {
    let r = n.stringPrefixes || _a.stringPrefixes, a = null, c = l.changeByRange((f) => {
      ...
      if (g == t) {
        ...
        if (l.charCategorizer(h)(g) != It.Word && Q1(l, h, r) > -1 && !ND(l, h, t, r)) return {
          changes: {
            insert: t + t,
            from: h
          },
  ...
  function VD(l, t) {
    return l.field(ci, false) ? t : t.concat(St.appendConfig.of(PD));
  }
  ...
  function ZD(l, t = 'viewBox="0 0 40 40"') {
    return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${t}>${encodeURIComponent(l)}</svg>')`;
  }
  function kc(l) {
    return ZD(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${l}" fill="none" stroke-width=".7"/>`, 'width="6" height="3"');
  }
  const WD = P.baseTheme({
    ".cm-diagnostic": {
  ...
  var P1 = function(t) {
    ...
    t.closeBracketsKeymap !== false && (n = n.concat(OD)), t.defaultKeymap !== false && (n = n.concat(wO)), t.searchKeymap !== false && (n = n.concat(WO)), t.historyKeymap !== false && (n = n.concat(O3)), t.foldKeymap !== false && (n = n.concat(GT)), t.completionKeymap !== false && (n = n.concat(Px)), t.lintKeymap !== false && (n = n.concat(KD));
    var r = [];
    return t.lineNumbers !== false && r.push(Ik()), t.highlightActiveLineGutter !== false && r.push(eT()), t.highlightSpecialChars !== false && r.push(pk()), t.history !== false && r.push(S3()), t.foldGutter !== false && r.push(ZT()), t.drawSelection !== false && r.push(sk()), t.dropCursor !== false && r.push(uk()), t.allowMultipleSelections !== false && r.push(Ot.allowMultipleSelections.of(true)), t.indentOnInput !== false && r.push(RT()), t.syntaxHighlighting !== false && r.push(FS(PT, {
      fallback: true
    })), t.bracketMatching !== false && r.push(l3()), t.closeBrackets !== false && r.push(MD()), t.autocompletion !== false && r.push(LD()), t.rectangularSelection !== false && r.push(Dk()), e !== false && r.push(Rk()), t.highlightActiveLine !== false && r.push(wk()), t.highlightSelectionMatches !== false && r.push(OO()), t.tabSize && typeof t.tabSize == "number" && r.push(pu.of(" ".repeat(t.tabSize))), r.concat([
      mu.of(n.flat())
    ]).filter(Boolean);
  };
  const ID = "#e5c07b", I1 = "#e06c75", $D = "#56b6c2", tE = "#ffffff", Vc = "#abb2bf", wm = "#7d8799", eE = "#61afef", iE = "#98c379", $1 = "#d19a66", nE = "#c678dd", lE = "#21252b", tv = "#2c313a", ev = "#282c34", Ad = "#353a42", sE = "#3E4451", iv = "#528bff", rE = P.theme({
    "&": {
      color: Vc,
      backgroundColor: ev
    },
  ...
  var cE = P.theme({
    ...
    switch (e && h.unshift(mu.of([
      AO
    ])), f && (typeof f == "boolean" ? h.unshift(P1()) : h.unshift(P1(f))), c && h.unshift(_k(c)), a) {
      case "light":
        h.push(cE);
        break;
      case "dark":
  ...
  function pE(l) {
    var { value: t, selection: e, onChange: n, onStatistics: r, onCreateEditor: a, onUpdate: c, extensions: f = gE, autoFocus: h, theme: g = "light", height: p = null, minHeight: y = null, maxHeight: v = null, width: S = null, minWidth: w = null, maxWidth: A = null, placeholder: _ = "", editable: T = true, readOnly: j = false, indentWithTab: L = true, basicSetup: Q = true, root: N, initialState: G } = l, [V, lt] = Pt.useState(), [tt, pt] = Pt.useState(), [at, I] = Pt.useState(), ft = Pt.useState(() => ({
      ...
      if (rt.docChanged && typeof n == "function" && !rt.transactions.some((H) => H.annotation(lv))) {
        ft.current ? ft.current.reset() : (ft.current = new hE(() => {
          if (ht.current) {
            var H = ht.current;
            ht.current = null, H();
          }
          ft.current = null;
        }, mE), dE().add(ft.current));
